...
onAction={()=>router.push("/calculators")}
...
This electricity powers your home and reduces your bill by up to 90%.
Excess energy can be exported to the grid via net metering.
</Text>
</View>
...
const SolarCard = ({title,desc,badge,details,open,onPress,onAction,actionLabel}:any)=>(
