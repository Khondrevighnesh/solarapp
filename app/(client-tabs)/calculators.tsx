    ...
    <Screen>
      ...
      >
        ...
        >
          ...
          >
            Plan solar investment with accurate estimation tools. Choose right
            system size, EMI plan & AMC services.
          </Text>
        </View>
        ...
        >
          ...
          <CalcCard
            icon={
              <Ionicons name="battery-charging" size={32} color="#9333EA" />
            }
        ...
        >
          ...
          >
            Our engineers analyze your electricity bill, roof space & load
            requirement to design best solar solution.
          </Text>
