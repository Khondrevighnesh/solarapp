    ...
    <Screen>
      ...
      >
        ...
        <View style={[GlobalStyles.card, { marginTop: Theme.spacing.lg }]}>
          <Text style={GlobalStyles.title}>Enter Load Details</Text>

          <Text style={{ marginTop: Theme.spacing.sm }}>Total Load (kW)</Text>
          ...
          <TouchableOpacity
            ...
            onPress={calculate}
          >
            <Text style={GlobalStyles.buttonText}>Calculate Battery</Text>
          </TouchableOpacity>
        </View>
        ...
        {backup && (
          <View style={GlobalStyles.card}>
            <Text style={GlobalStyles.title}>Battery Requirement</Text>
